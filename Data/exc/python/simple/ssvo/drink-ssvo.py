...
class DrinkSsvo:
    doc = Et.parse("C:/Users/lenova/Desktop/FYP/smart-learning-master/code/sentence/templates/SSVO/Drink.xml")
            ...
            if phrase.tag == "SUBJECTPHRASE":
                for child in phrase:
                    ...
                    if child.tag == "CONJUNCTION":
                        class0 = child.attrib
                        conj = open(
                            "C:/Users/lenova/Desktop/FYP/smart-learning-master/code/sentence"
                            "/conjunction.txt")
                        f1 = conj.readlines()
                        for i in f1:
                            if i.find(class0["class"] + ":", 0) == 0:
